  ...
  return (
    <main className="mx-auto max-w-3xl px-6 py-16 text-[15px]">
      ...
      <p className="mt-3 leading-7 text-gray-800">
        ...
        만들어 공유하는 iOS 앱입니다. 본 방침은 현재 제공 중인 버전을 기준으로
      ...
      <Section title="제13조 (개인정보 처리방침의 변경)">
        <p>
          ...
          페이지를 통해 고지합니다. 특히 회원 가입(소셜 로그인), 서버 전송, 서버 푸시
          알림(운영팀 서버에서 보내는 알림 — 현재 제공 중인 러닝 감지 알림은 기기 안에서만
          만들어지는 로컬 알림입니다) 등이 도입되는 시점에 본 방침이 개정됩니다.
        </p>
