    ...
    <main className="mx-auto max-w-3xl px-6 py-16 text-[15px]">
      ...
      <div className="mt-8 rounded-lg border border-gray-300 bg-gray-50 p-5">
        ...
        <ul className="mt-3 list-disc space-y-1 pl-5">
          ...
          <li><strong>처리 항목:</strong> 러닝 기록(HealthKit·기록 화면 캡처) — 기기에서 처리하고 측정값을 서버에 백업(GPS 경로 제외), 러닝 장소 지명 표시를 위해 경로 첫 좌표 1개를 Apple에 전송(제5조·제11조) / 사진·영상 — 이용자 기기 안에서만 처리·보관 (일부 콘텐츠 분석 시 외부 AI 이용 가능, 제5조) / 기기 정보·앱 이용 기록 — 서버 등록·분석 도구로 전송(제5조)</li>
          ...
          <li><strong>제3자 제공:</strong> 하지 않음 (다만 앱 이용 기록 분석과 좌표의 지명 변환 업무를 국외 업체에 위탁, 제5조)</li>
      ...
      <Section title="제5조 (개인정보 처리의 위탁 및 국외 이전)">
        ...
        <p>
          이와 별개로, 운영팀은 서비스 품질 개선과 오류 대응을 위한 앱 이용 기록 처리 업무와
          러닝 장소 지명 표시를 위한 좌표의 지명 변환 업무를 다음 업체에 위탁하고 있습니다.
          세 업체의 서버가 국외에 있어 아래 항목이 국외로 이전됩니다.
        </p>
        <div className="overflow-x-auto">
          <table className="w-full border-collapse text-left">
            <thead>
            ...
            <tbody>
              <tr className="border-b border-gray-200">
                ...
                <td className="p-2">익명 기기 식별자, 기능 사용 이벤트, 사용 경험 평가 응답, 러닝 기록 파생값(거리 구간, 경로 보유 여부, 지명 보유 여부)</td>
      ...
      <Section title="제13조 (개인정보 처리방침의 변경)">
        ...
        <p className="text-gray-600">
          이번 개정으로 러닝 장소 지명 기능이 반영되었습니다. 개정 전 방침(2026년 8월 28일
          시행)에서 달라진 부분은 러닝 경로 첫 좌표 1개의 Apple 국외 이전(제5조·제11조), 러닝
          기록 항목의 지명 추가(제1조), 분석 파생값에 지명 보유 여부 추가(제5조·제11조)입니다.
        </p>
        <p className="text-gray-600">
          이번 개정은 공고와 동시에 시행합니다. 새로 처리하는 좌표 전송은 이용자가 오버레이
          편집 기능을 직접 열 때만 일어나고, 그 밖의 처리 내용은 이전과 같아서 미리 알릴 기간을
          두지 않았습니다.
        </p>
        <p><strong>공고일 및 시행일: 2026년 9월 2일</strong></p>
      </Section>
    </main>
  );
}
