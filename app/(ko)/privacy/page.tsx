    ...
    <main className="mx-auto max-w-3xl px-6 py-16 text-[15px]">
          ...
          <table className="w-full border-collapse text-left">
            ...
            <tbody>
              ...
              <tr className="border-b border-gray-200">
                ...
                <td className="p-2">러닝 시간대에 촬영된 사진·영상(베스트컷 추천·편집 대상). 기기 안에서만 처리하며, <strong>AI 템플릿을 쓸 때만</strong> 이용자가 영상에서 고른 프레임 1장(가로 512픽셀로 줄인 정지 이미지 — 얼굴이 나올 수 있음)과 템플릿 종류를 운영팀 서버를 거쳐 제5조의 AI 업체로 보냅니다. 영상 전체나 다른 프레임은 보내지 않습니다</td>
      ...
      <Section title="제2조 (개인정보의 처리 목적)">
        <ul className="list-disc space-y-1 pl-5">
          ...
          <li>AI 템플릿의 자세 판독과 정지컷 생성. 이용자가 고른 영상 프레임 1장에서 손 위치와 기록 글자를 얹을 자리를 판독하고, 템플릿에 따라 그 프레임을 바탕으로 효과를 더한 정지컷 이미지를 새로 만듭니다. <strong>정지컷을 만들 때는 프레임 속 인물의 얼굴·몸이 AI에 의해 다시 그려질 수 있습니다.</strong> 만들어진 정지컷은 이용자 기기에만 저장되며, 누구인지 알아보는 처리(같은 사람 찾기, 얼굴 특징 추출)는 하지 않습니다</li>
      ...
      <Section title="제3조 (개인정보의 처리 및 보유 기간)">
        ...
        <ul className="list-disc space-y-1 pl-5">
          ...
          <li>
            ...
            기록에는 작업 번호·파일 크기·처리 상태만 남습니다. AI가 만든 정지컷은 이용자
            기기에만 저장되고, 그 정지컷을 쓴 초안을 지우면 함께 삭제됩니다.
          </li>
      ...
      <Section title="제5조 (개인정보 처리의 위탁 및 국외 이전)">
          ...
          <table className="w-full border-collapse text-left">
            ...
            <tbody>
              ...
              <tr className="border-b border-gray-200">
                ...
                <td className="p-2">이용자가 고른 영상 프레임 1장(가로 512픽셀 정지 이미지 — 얼굴이 나올 수 있음), 템플릿 종류</td>
                <td className="p-2">프레임 속 손 위치와 기록 글자를 얹을 자리 판독. OpenAI의 정지컷 생성이 안전 정책에 막히면 대신 정지컷 생성 / 판독 결과를 돌려줄 때까지. 구글은 유료 API 약관에 따라 프레임을 학습이나 제품 개선에 쓰지 않고, 금지 행위 감시 목적으로만 제한된 기간 보관합니다</td>
              </tr>
              <tr className="border-b border-gray-200">
                <td className="p-2 font-semibold">
                  OpenAI, L.L.C.
        ...
        <p>
          ...
          1장입니다. 프레임은 기록 오버레이를 입히기 전의 원본 화면이라 러닝 기록 수치가 담기지
